                                        ...
                                        <Link to={`/watch/${item.snippet.categoryId}/${item.id}`} key={index} className='flex gap-2 w-full '>
                                            ...
                                            <div className='flex flex-col gap-2 w-full'>
                                                <div className='flex justify-between w-[95%]'>
                                                    <h3 className='text-[#0f0f0f] text-sm max-sm:text-[0.55rem]'> {item.snippet.title} </h3>
                                                    <div className="dropdown dropdown-end">
                                                ...
                                                <h3 className='text-[#606060] text-xs max-sm:text-[0.50rem]'>{item.snippet.channelTitle}</h3>
                                                <p className='text-[#606060] text-xs max-sm:text-[0.50rem]'>{likesValue(item.statistics.viewCount)} مشاهدة </p>
                                            </div>
                                        </Link>
                                    )
